...
JQ_STRATEGY_DATA_DIR = BACKEND_ROOT / "data" / "jq_strategy"
JQ_STRATEGY_RAW_DIR = JQ_STRATEGY_DATA_DIR / "raw"
JQ_STRATEGY_CHROMA_PATH = JQ_STRATEGY_DATA_DIR / "chroma_db"
JQ_STRATEGY_BM25_PATH = JQ_STRATEGY_DATA_DIR / "bm25.pkl"
JQ_STRATEGY_MANIFEST_PATH = JQ_STRATEGY_DATA_DIR / "manifest.json"
JQ_STRATEGY_SUMMARIES_PATH = JQ_STRATEGY_RAW_DIR / "summaries.jsonl"

JQ_STRATEGY_COLLECTION_NAME = "jq_strategy_chunks"
